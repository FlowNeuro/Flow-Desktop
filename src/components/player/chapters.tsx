          ...
          <div className="px-4 py-2 border-b border-white/5 bg-white/5 flex items-center justify-between shrink-0">
            ...
            <div className="relative">
              <select
                ...
                className="appearance-none bg-zinc-900 border border-white/10 hover:border-white/20 text-zinc-200 text-xs rounded-lg pl-3 pr-8 py-1.5 focus:outline-none focus:ring-1 focus:ring-primary cursor-pointer font-medium"
              >
                {captions.map((track) => (
                  <option key={track.id} value={track.id}>
                    {track.label} {track.isAutoGenerated ? "(auto)" : ""}
                  </option>
                ))}
              </select>
