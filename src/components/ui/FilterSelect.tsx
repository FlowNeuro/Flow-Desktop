  ...
  return (
    <div ref={ref} className={cx('relative shrink-0', className)}>
      <button
        ...
        aria-expanded={open}
        className="inline-flex h-9 items-center gap-1.5 rounded-lg border border-neutral-800 bg-surface-container-high px-3 text-sm text-neutral-00 transition-colors duration-200 ease-out hover:bg-surface-container-highest focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-primary)]"
      >
      ...
      {open && (
        <div
          role="listbox"
          className="absolute right-0 z-40 mt-2 min-w-[12rem] overflow-hidden rounded-xl border border-neutral-800 bg-surface-container-high py-1.5"
        >
          {options.map((o) => {
